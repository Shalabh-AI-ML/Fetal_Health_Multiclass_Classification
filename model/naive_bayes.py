...
val_accuracy = naive_bayes_model.score(X_val_scaled, y_val)
print(f"Validation Accuracy: {val_accuracy:.4f}")

# Save the trained model
joblib.dump(naive_bayes_model, "saved_model/naive_bayes_model.pkl")
print("Model saved successfully.")

joblib.dump(data_processor.scaler, "saved_model/naive_bayes_scaler.pkl")
